...
public class PerformanceItemReader implements ItemReader<KopisPerformanceApiDto> {
    ...
    private final List<KopisPerformanceApiDto> performanceBuffer = new ArrayList<>();
    ...
    private KopisPerformanceApiDto popFromBuffer() {
    ...
    private void fetchDataForCurrentPeriod() {
        ...
        List<KopisPerformanceApiDto> fetched = kopisPerformanceDataProvider.fetchPerformances(
    ...
    private boolean hasData(List<KopisPerformanceApiDto> fetched) {
